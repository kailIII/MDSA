...
class EstadoCivil(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir nombre del estado civil.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='estado_civiles_usuario_editor')
