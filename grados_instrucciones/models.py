...
class GradoInstruccion(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text="Escribir el grado de instrucción.")
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='grado_instruccion_usuario_editor')
	...
	class Meta:
		...
		verbose_name = 'Grado Instrucción' 
		#Nombre en Plural en la lista de módulos en el Panel de Administración
		verbose_name_plural = 'Grados de Instrucciones'#Métodos