...
class Prioridad(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text="Escribir prioridad.")
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='prioridad_usuario_editor')
	...
	class Meta:
		...
		verbose_name_plural = 'Prioridades'#Métodos