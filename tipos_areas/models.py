...
class TipoArea(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir el tipo de área, Ejemplo: Oficina, Unidad, etc.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='tipo_area_usuario_editor')
	...
	class Meta:
		...
		verbose_name_plural = 'Tipos de Áreas'#Métodos