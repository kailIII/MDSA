...
class CodigoBarra(models.Model):
	nombre 							= models.CharField(max_length=255, help_text="Escribir nombre del código barra.")
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='codigo_barra_usuario_editor')
